...
# PAGE 3: DETAIL VIEW
    ...
    if df_detail is not None:
        ...
        if prob_score > 60:
            ...
            signal_msg = "📉 SELL ALERT"
        else:
            signal_msg = "⚖️ NEUTRAL"
        ...
        with cr:
            ...
            <p style="margin-top:20px; font-weight:bold; color:{'#22c55e' if prob_score > 50 else '#ef4444'}; font-size:1.5rem;">{signal_msg}</p>
            </div>
            """, unsafe_allow_html=True)
